...
function updateStage(pChoice, cChoice) {
  playerImg.setAttribute("src", `./images/${pChoice}.jpg`);
  compImg.setAttribute("src", `./images/${cChoice}.jpg`);
}
...
function announceWinner() {
  if (playerScoreNum == 5 || compScoreNum == 5) {
    running = false;
...
function reset() {
  ...
  playerScoreNum = 0;
  compScoreNum = 0;
  result.textContent = "First to score 5 points wins";
